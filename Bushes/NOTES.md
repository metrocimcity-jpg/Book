...
- `data/bushes.json` is a root stub with no children. Taxonomy was not copied from Mammalia and was not invented.
- Switch to this group from the hub: `/?group=bushes`.

## Taxonomy harvest 2026-09-20

- Source: WCVP names table, lifeform filter for bushes (43398 species with order).
- Counts: 64 orders, 236 families, 3428 genera, 43398 species.
