# Flowers sunburst — working notes
...
- `data/flowers.json` is a root stub with no children. Taxonomy was not copied from Mammalia and was not invented.
- Switch to this group from the hub: `/?group=flowers`.

## Taxonomy harvest 2026-09-20

- Source: WCVP names table, lifeform filter for flowers (106477 species with order).
- Counts: 63 orders, 244 families, 5384 genera, 106477 species.
