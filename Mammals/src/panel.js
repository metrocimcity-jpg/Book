...
export function createPanel(root, { credits = {}, meta = null, totalSpecies = 0 } = {}) {
  ...
  function citation(info) {
    return el("p", { class: "citation-block" }, [
      `${info.source || "ASM Mammal Diversity Database"} ${info.version || ""}. `,
  ...
  function links(node) {
    ...
    return el("p", { class: "ext-links" }, [
      ...
      el("a", { class: "ext", href: `https://www.mammaldiversity.org/`, rel: "noopener noreferrer", target: "_blank" }, "MDD (leaves page)")
    ]);
  }
  ...
  function show(node, { speciesName = null } = {}) {
    ...
    body.append(
      ...
      el("div", { class: "counts" }, [
        ...
        el("div", {}, [el("b", { text: formatPercent(species, totalSpecies) }), " of mammals"])
      ]),
      speciesList(node),
      links(node)
    );
