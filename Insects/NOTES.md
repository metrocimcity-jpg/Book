# Insecta sunburst — working notes
...
- `data/insects.json` is a root stub with no children. Taxonomy was not copied from Mammalia and was not invented.
- Switch to this group from the hub: `/?group=insects`.

## Taxonomy harvest 2026-09-20

- Source: GBIF Insecta children. Family leaves with species counts.
- Counts: 42 orders, 2113 families, 1102569 species (counted, not listed).
